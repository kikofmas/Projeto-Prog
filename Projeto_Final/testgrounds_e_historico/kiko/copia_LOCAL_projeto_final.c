...
dados **jogo(int num_jogadores, int num_jogos, int num_cores, int tamanho_chave, int duracao_jogo,\
            int tentativas, char repeticao_cores, char **nome_jogadores, game_reg **registo_jogo);  //funcao que permite jogar
  ...
  if (cmd_flag.init==0 && cmd_flag.hist==0 && cmd_flag.ord==0) {
    ...
    //JOGO
      ...
      ptr_dados=jogo(defs_jogo.num_jogadores, defs_jogo.num_jogos, defs_jogo.num_cores, defs_jogo.tamanho_chave,
                     defs_jogo.duracao_jogo, defs_jogo.tentativas, defs_jogo.repeticao_cores, nome_jogadores, &registo_jogo);
...
******************************************************************************/
dados **jogo(int num_jogadores, int num_jogos, int num_cores, int tamanho_chave, int duracao_jogo,
          int tentativas, char repeticao_cores, char **nome_jogadores, game_reg **registo_jogo){
